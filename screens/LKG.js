    ...
    return (
        <View style={styles.main}>
            ...
            <View style={styles.hangman1}>
                <Text style={styles.title}> LKG</Text>
            </View>
            <View style={styles.hangman}>
                <ScrollView>


                <TouchableOpacity style={styles.middle} onPress={() => props.navigation.navigate("LKGMaths")}>
                    ...
                    <TouchableOpacity style={styles.middle} onPress={() => props.navigation.navigate("LKGEnglish")}>
                    ...
                    <TouchableOpacity style={styles.middle} onPress={() => props.navigation.navigate("LKGEVS")}>
                    ...
                    <TouchableOpacity style={styles.middle} onPress={() => props.navigation.navigate("LKGhindi")}>
                        <View style={styles.class3}>
                            <View style={styles.top}>
