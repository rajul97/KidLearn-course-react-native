...
const LKGMaths = (props) => {
  return (
    ...
    <View style={styles.hangman}>
        ...
        <TouchableOpacity style={styles.middle} onPress={() => props.navigation.navigate("Oneto")}>
                <View style={styles.class}>
                    <View style={styles.top}>
                        <Image source={require('../assets/image/pip1.png')} style={styles.glass}></Image>
            ...
            <TouchableOpacity style={styles.middle} onPress={() => props.navigation.navigate("MathsConcept")}>
                <View style={styles.class}>
                    <View style={styles.top}>
                        <Image source={require('../assets/image/pip2.png')} style={styles.glass}></Image>
            ...
            <View style={styles.class}>
                <View style={styles.top}>
                    <Image source={require('../assets/image/pip3.png')} style={styles.glass}></Image>
                    <Text style={styles.title1}>Shapes</Text>
                </View>
            </View>
        </TouchableOpacity>
        ...
        <View style={styles.class}>
            <View style={styles.top}>
                <Image source={require('../assets/image/MODI.png')} style={styles.glass}></Image>
    ...
    <View style={styles.class}>
        <View style={styles.top}>
            <Image source={require('../assets/image/pip5.png')} style={styles.glass}></Image>
            <Text style={styles.title1}>NumberCounting</Text>
        </View>
    </View>
</TouchableOpacity>
