  ...
  return (
    ...
    <View style={styles.mid}>
        ...
        <View style={styles.air}>
              ...
              <TouchableOpacity>
                <View style={styles.A}>
                <Image source={require('../assets/image/freee1.png')} style={styles.one}></Image>
                </View>
                </TouchableOpacity>
                ...
                <TouchableOpacity>
                <View style={styles.A}>
                <Image source={require('../assets/image/freee3.png')} style={styles.one}></Image>
                </View>
                </TouchableOpacity>
                ...
                <TouchableOpacity>
                <View style={styles.A}>
                <Image source={require('../assets/image/freee4.png')} style={styles.one}></Image>
                </View>
                </TouchableOpacity>
